...
async function enableForms() {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    const income_eur = parseFloat(
      document.getElementById("donation-income").value,
    );
  ...
  document
    .getElementById("donation-cancel")
    .addEventListener("click", resetDonationForm);

  document
    .querySelector("#donations tbody")
  ...
  supporterForm.addEventListener("submit", async (e) => {
    ...
    const income_eur = parseFloat(
      document.getElementById("supporter-income").value,
    );
    ...
    try {
      if (!supporterId) {
        ...
        const supporterUpdate = await fetch(
          `${baseUrl}/supporters/${supporterId}`,
          {
            method: "PUT",
            headers: { "Content-Type": "application/json" },
            credentials: "include",
  ...
  document
    .getElementById("supporter-cancel")
    .addEventListener("click", resetSupporterForm);

  document
    .querySelector("#supporters tbody")
    .addEventListener("click", async (e) => {
      ...
      if (e.target.classList.contains("edit-supporter")) {
        ...
        document.getElementById("supporter-income-label").style.display =
          "none";
